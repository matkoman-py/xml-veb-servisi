        ...
        <html>
            ...
            <body>
                ...
                <table class="mid">
                    ...
                    <tr>
                        <td style="padding-bottom:5px"><b>Tip/Type:</b></td>
                        <td style="padding-bottom:5px"><b>Tip/Type:</b></td>
                    </tr>
                    <tr>
                        <td style="padding-bottom:5px"><xsl:value-of select="/zel:zeleni_sertifikat/zel:podaci_o_vakcinaciji[1]/zel:tip[1]"/></td>
                        <td style="padding-bottom:5px"><xsl:value-of select="/zel:zeleni_sertifikat/zel:podaci_o_vakcinaciji[2]/zel:tip[1]"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding-bottom:5px; border-bottom:2px solid black"><xsl:value-of select="/zel:zeleni_sertifikat/zel:podaci_o_vakcinaciji[1]/zel:zdravstvena_ustanova[1]"/></td>
                        <td style="padding-bottom:5px; border-bottom:2px solid black"><xsl:value-of select="/zel:zeleni_sertifikat/zel:podaci_o_vakcinaciji[2]/zel:zdravstvena_ustanova[1]"/></td>
                    </tr>
                </table>
                <p style="text-align:right"><b>Digitalni potpis/Digitally signed by:</b></p>
                <table>
                    <tr>
                        <td style="width:100px; padding-right:5px;"><p style="text-align:left;"><img src="https://data.gov.rs/s/avatars/2e/7864606e35474b98eb147395fecb72-100.png" width="100" height="100"></img></p>
                        </td>
