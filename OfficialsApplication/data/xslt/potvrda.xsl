...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:pot="www.ftn.uns.ac.rs/potvrda_o_vakcinaciji" version="2.0">
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <p class="form">Datum davanja i broj serije trece doze vakcine: <xsl:value-of select="/pot:Potvrda/pot:Vakcinacija_info[1]/pot:Treca_doza[1]/pot:Datum_vakcine[1]"/>, serija: <xsl:value-of select="/pot:Potvrda/pot:Vakcinacija_info[1]/pot:Treca_doza[1]/pot:Serija_vakcine"/></p>
                <p class="small">Third Vaccination Date:</p>
