        ...
        <html>
            ...
            <body>
                ...
                <table>
                    ...
                    <tr>
                        <td><div style="height: 50px; overflow:hidden; font-size:12px; text-align:left;">
                            Datum i vreme izdavanja sertifikata/Certificate isuing date and time: <xsl:value-of select="/zel:zeleni_sertifikat/substring-before(zel:datum_izdavanja, 'T')"/>
                        </div></td>
                    </tr>
                    <tr>
                        <td><div style="height: 50px; overflow:hidden; font-size:12px; text-align:left;">
                ...
                <table class="mid">
                    ...
                    <tr>
                        <td style="padding-bottom:10px">POPUNI</td>
                        <td style="padding-bottom:10px">POPUNI</td>
                    </tr>
                    <tr>
                        <td><b>Datum/Date:</b> POPUNI</td>
                        <td><b>Datum/Date:</b> POPUNI</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding-bottom:10px; border-bottom:2px solid black">Popuni</td>
                        <td style="padding-bottom:10px; border-bottom:2px solid black">POPUNI</td>
                    </tr>
                </table>
                ...
                <table>
                    <tr>
                        ...
                        <td><p style="text-align:left; font-size:10px">REPUBLIKA SRBIJA<br></br>Vlada Republike Srbije<br></br>Kancelarija za informacione<br></br>tehnologije i elektronsku upravu<br></br>Nemanjina 11, BEOGRAD <br></br>Datum:DODAJ</p>
